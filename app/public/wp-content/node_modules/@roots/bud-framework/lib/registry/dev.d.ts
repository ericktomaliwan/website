...
import type { Connection, Middleware, Options, Server } from '@roots/bud-framework/services/server';
...
export interface Sync {
    ...
    'middleware.proxy.options.target': Middleware.Available['proxy']['options']['target'] & URL;
