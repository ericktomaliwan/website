...
export const get = function (label, tap) {
    ...
    !isRoot &&
        warn(`${label} instance requested from ${this.label}, but this is not the root instance. Returning from the context of ${root.label}`);
    if (!root.children?.[label]) {
        throw BudError.normalize(`bud.get: bud.children['${label}'] is undefined`, {
