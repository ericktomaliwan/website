...
import { Extension, type Getter, type Setter } from '@roots/bud-framework/extension';
...
declare class WordPressThemeJson extends Extension<Options, ThemeJsonWebpackPlugin> {
    ...
    getCustomTemplates: Getter<Options, `customTemplates`>;
    setCustomTemplates: Setter<WordPressThemeJson, Options, `customTemplates`>;
    readonly __generated__: Options[`__generated__`];
    get__generated__: Getter<Options, `__generated__`>;
    set__generated__: Setter<WordPressThemeJson, Options, `__generated__`>;
    readonly path: Options['path'];
    getPath: Getter<Options, `path`>;
    setPath: Setter<WordPressThemeJson, Options, `path`>;
    readonly patterns: Options['patterns'];
    getPatterns: Getter<Options, `patterns`>;
    setPatterns: Setter<WordPressThemeJson, Options, `patterns`>;
    getSettings: Getter<Options, `settings`>;
    setSettings: Setter<WordPressThemeJson, Options, `settings`>;
    readonly styles: Options['styles'];
    getStyles: Getter<Options, `styles`>;
    setStyles: Setter<WordPressThemeJson, Options, `styles`>;
    readonly title: Options['title'];
    getTitle: Getter<Options, `title`>;
    setTitle: Setter<WordPressThemeJson, Options, `title`>;
    readonly version: Options['version'];
    getVersion: Getter<Options, `version`>;
    setVersion: Setter<WordPressThemeJson, Options, `version`>;
    readonly templateParts: Options['templateParts'];
    getTemplateParts: Getter<Options, `templateParts`>;
    setTemplateParts: Setter<WordPressThemeJson, Options, `templateParts`>;
    /**
     ...
     * ```
     */
    removeDefaultSuffix?: (value?: boolean) => WordPressThemeJson;
    /**
