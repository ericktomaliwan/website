    ...
    async execute() {
        ...
        await Promise.all([
            ...
            [
                ...
                `BUD_HOT`,
                `hot`,
                b => async (v) => b.root.hooks.on(`dev.middleware.enabled`, ware => ware?.filter(key => (v === false ? key !== `hot` : v)) ??
                    []),
            ],
            [
                this.html,
            ...
            [
                ...
                `BUD_PROXY_URL`,
                `proxy.url`,
                b => async (v) => b.root.hooks.on(`dev.middleware.proxy.options.target`, new URL(v)),
                false,
            ],
            [
                this.runtime,
