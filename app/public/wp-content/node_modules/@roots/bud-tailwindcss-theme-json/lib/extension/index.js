...
import * as tailwindAdapter from '@roots/bud-tailwindcss-theme-json/tailwind';
...
let TailwindThemeJSON = class TailwindThemeJSON extends Extension {
    ...
    removeDefaultSuffix(value = true) {
...
__decorate([
    bind
], TailwindThemeJSON.prototype, "removeDefaultSuffix", null);
__decorate([
    bind
