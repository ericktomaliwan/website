...
export default class BudPresetWordPress extends Extension<Options> {
    ...
    getScriptDebug: Getter<Options, `scriptDebug`>;
    setScriptDebug: Setter<BudPresetWordPress, Options, `scriptDebug`>;
    /**
     ...
     */
    getExclude: Getter<Options, `exclude`>;
    /**
     * Set excluded dependencies
     */
    setExclude: Setter<BudPresetWordPress, Options, `exclude`>;
    /**
     ...
     * ```
     */
    setHmr: Setter<BudPresetWordPress, Options, `hmr`>;
    /**
     ...
     * @returns boolean
     */
    getNotify: Getter<Options, `notify`>;
    /**
     ...
     * ```
     */
    setNotify: Setter<BudPresetWordPress, Options, `notify`>;
    /**
