import type { Compiler, Configuration, EntryObject, FileCacheOptions, Optimization, RuleSetRule, StatsOptions } from '@roots/bud-framework/config';
...
export interface Async {
    ...
    resolve: any;
    'resolve.alias': {
        [index: string]: false | string | string[];
    } | undefined;
