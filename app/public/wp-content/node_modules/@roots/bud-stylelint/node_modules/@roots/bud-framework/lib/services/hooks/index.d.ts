...
export interface Hooks {
     ...
     * ```
     */
    async: <T extends `${keyof Registry.AsyncStore & string}`>(id: T, value: Registry.AsyncCallback[T]) => Bud;
    /**
     ...
     * ```
     */
    filter: <K extends `${keyof Registry.SyncRegistry & string}`>(id: K, callback?: Registry.SyncRegistry[K]) => Registry.SyncRegistry[K];
    /**
