...
export type LifecycleMethods = 'boot' | 'buildAfter' | 'buildBefore' | 'compilerDone' | 'configAfter' | 'make' | 'register';
/**
...
export interface Extensions {
    ...
    instantiate<K extends `${keyof Modules & string}`>(extension: Extension | (new (...args: any[]) => Modules[K]), options?: Record<string, any>): Promise<Extension>;
    ...
    repository: Modules;
    run(extension: Modules[keyof Modules], methodName: LifecycleMethods): Promise<this>;
