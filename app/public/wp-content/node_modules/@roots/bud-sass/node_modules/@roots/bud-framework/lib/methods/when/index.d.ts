...
export interface when {
    (test: ((app: Bud) => boolean) | Array<((app: Bud) => boolean) | boolean> | boolean, trueCase: ((app: Bud) => any) | Array<(app: Bud) => any>, falseCase?: ((app: Bud) => any) | Array<(app: Bud) => any>): Bud;
}
/**
 ...
 * ```
 */
export declare function when(test: ((app: Bud) => boolean) | Array<((app: Bud) => boolean) | boolean> | boolean, trueCase: ((app: Bud) => any) | Array<(app: Bud) => any>, falseCase?: ((app: Bud) => any) | Array<(app: Bud) => any>): Bud;
