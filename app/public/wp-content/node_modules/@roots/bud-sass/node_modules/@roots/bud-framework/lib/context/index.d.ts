...
export interface Context {
     ...
     */
    devtool?: `cheap-module-source-map` | `cheap-source-map` | `eval-cheap-module-source-map` | `eval-cheap-source-map` | `eval-nosources-cheap-modules-source-map` | `eval-nosources-cheap-source-map` | `eval-nosources-source-map` | `eval-source-map` | `eval` | `hidden-cheap-module-source-map` | `hidden-cheap-source-map` | `hidden-nosources-cheap-module-source-map` | `hidden-nosources-cheap-source-map` | `hidden-nosources-source-map` | `hidden-source-map` | `inline-cheap-module-source-map` | `inline-cheap-source-map` | `inline-nosources-cheap-module-source-map` | `inline-nosources-cheap-source-map` | `inline-nosources-source-map` | `inline-source-map` | `nosources-cheap-module-source-map` | `nosources-cheap-source-map` | `source-map` | false;
    /**
     * Discover option
     *
     * @remarks
