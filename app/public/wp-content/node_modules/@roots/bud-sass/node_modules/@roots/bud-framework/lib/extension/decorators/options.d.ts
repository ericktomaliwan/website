import type { InternalOptions, OptionsInterface as Options } from '@roots/bud-framework/extension/types';
/**
 ...
 */
export declare const options: <Opts extends Options = Record<string, unknown>>(options: Partial<InternalOptions<Opts>>) => <Type extends {
    new (...args: any[]): any;
}>(constructor: Type) => {
    new (...args: any[]): {
        [x: string]: any;
