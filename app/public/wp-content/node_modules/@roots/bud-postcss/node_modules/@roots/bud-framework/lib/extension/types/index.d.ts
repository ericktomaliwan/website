...
export type OptionCallback<T extends OptionsInterface, K extends `${keyof OptionsInterface & string}`> = ((value: T[K]) => T[K]) | T[K];
export type OptionCallbackValue<T extends OptionsInterface, K extends `${keyof OptionsInterface & string}`> = ((value: T[K]) => T[K]) | InternalOptions<T>[K];
export type Setter<Extension, OptionsInterface, Property extends `${keyof OptionsInterface & string}`> = (value: OptionCallbackValue<OptionsInterface, Property>) => Extension;
export type Getter<Options extends OptionsInterface = OptionsInterface, Property extends `${keyof OptionsInterface & string}` = `${keyof OptionsInterface & string}`> = () => Options[Property];
export type Accessor<Options extends OptionsInterface, Property extends `${keyof OptionsInterface & string}`> = Options[Property];
export type Option<Extension, Options extends OptionsInterface, Property extends `${keyof Options & string}`> = {
...
export type ExtensionApi<Context, Options extends OptionsInterface> = BudExtension<Options> & WithOptions<Context, Options>;
/**
 * Webpack plugin.
 */
...
export interface BudExtension<Options extends OptionsInterface = OptionsInterface, Plugin extends ApplyPlugin = ApplyPlugin> {
    _app: () => Bud;
     ...
     * Set option
     */
    setOption<K extends string>(key: K, valueOrCallback: OptionCallbackValue<Options, K>): BudExtension;
    /**
     * Set options
     */
